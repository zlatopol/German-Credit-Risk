...
При этом XGBoost был выбран для дальнейшей оптимизации.
...
На тестовой выборке были дополнительно проверены разные thresholds:
...
Threshold `0.236` выбирался по validation, а не по test.
